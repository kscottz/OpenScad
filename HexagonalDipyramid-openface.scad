...
p_describe(solid_1);
solid_2 = openface(solid_1,outer_inset_ratio=0.35,inner_inset_ratio=0.35,depth=0.3,fn=[]);
scale(1) show_solid(solid_2);

function Z() = HexagonalDipyramid();
function HexagonalDipyramid() = 
// source:  http://dmccooey.com/polyhedra/HexagonalDipyramid.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
let(C0 = 0.577350269189625764509148780502)
let(C1 = 1.15470053837925152901829756100)
poly(name = "Hexagonal Dipyramid",
// 3 sided faces = 12
vertices = [
[ 0.0, 0.0,  2.0],
[ 0.0, 0.0, -2.0],
